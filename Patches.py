...
def patch_rom(spoiler:Spoiler, world:World, rom:Rom):
    ...
    # Fix Deadhand spawn coordinates in vanilla shadow temple and bottom of the well to be the exact centre of the room
    # This prevents the extremely small possiblity of deadhand spawning outside of collision
